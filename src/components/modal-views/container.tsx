    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Overlay className="fixed inset-0 z-0 cursor-pointer bg-gray-700 bg-opacity-60 backdrop-blur" />
        </Transition.Child>
        ...
        >
          <div className="'relative xs:w-auto' z-50 inline-block w-full text-left align-middle xs:w-auto">
